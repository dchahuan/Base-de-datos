        ...
        <div class="row justify-content-around">
            ...
            foreach($puertos as $p){
                ...
                <div class='card-body'>
                  ...
                  <h6 class='card-subtitle mb-2 text-muted'>$p[1], $p[2], Chile</h6>
                <form method = 'POST' action = 'naviera.php'>
                    <input value='$p[0]' name='nid' class = 'd-none' type='text' disable>
                    <input value='$p[1]' name='name' class = 'd-none' type='text' disable>
