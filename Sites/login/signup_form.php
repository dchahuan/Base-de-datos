    ...
    <form action="/login/scripts/singup.php" method="post">
        <div class = "form">
            ...
            <div class="form-group">
                ...
                <input type="num" min = "0" step = "1" class = "col-9 form-control"name="edad" placeholder = "Edad" id = "edad">
            </div>
            <div class="form-group">
                <label for="pasaporte" class = "col-3 control-label">Numero de pasaporte: </label>
                <input type="text" name="pasaporte" class = "col-9 form-control" placeholder = "Numero de pasaporte" id = "pasaporte">
            </div>
            <div class="form-group">
                <label for="nacionalidad" class = "col-3 control-label">Nacionalidad </label>
                <input type="text" name="nacionalidad" class = "col-9 form-control" placeholder = "Nacionalidad" id = "nacionalidad">
            </div>
            ...
            <div class="form-group">
                ...
                <input type="password" class = "col-9 form-control" name="pwd-r" placeholder = "Reapeat your password">
            </div>
        </div>
